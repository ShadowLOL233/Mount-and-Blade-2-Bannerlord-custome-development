# BetterPatrolsBrake build + deploy.
param(
...
Write-Host "`nDeploy done. Enable 'BetterPatrols Brake' in launcher (loads AFTER BetterPatrols)." -ForegroundColor Yellow
