...
$here = $PSScriptRoot
$modName = 'GarrisonDrillsMessageEnhancer'
...
Write-Host "`nDeploy done. Enable 'Garrison Drills Message Enhancer' in the Bannerlord launcher Mods tab." -ForegroundColor Yellow
