# RBMPlayerStaminaPoiseBuff build + deploy.
param(
...
$here = $PSScriptRoot
$modName = 'RBMPlayerStaminaPoiseBuff'
...
Write-Host "`nDeploy done. Enable 'RBM Player Stamina & Poise buff Mod' in launcher (loads after RBM)." -ForegroundColor Yellow
